    ...
    if age is not None:
        ...
        if age < 0 or age >= 65:
            return build_validation_result(
                False,
                "age",
                "I apologize, but you must be between the ages of 0-64 to partake in our investment programs. Please provide a valid age.")
    if investmentAmount is not None:
        ...
        if investmentAmount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "We have a minimum of $5000.00 for our investment program."
...
def dispatch(intent_request): # comes from event and is JSON starting from lambda_handler.
    ...
    if intent_name == "RecommendPortfolio": #"RecommendPortfolio is the only intent name"
